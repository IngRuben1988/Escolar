...
echo"<a href='horarios-alumno.php?curp=".$CURP."&semestre=".$row2['SEM_GRADO_NUMERO']."' target='horarios-alumno' onclick='window.open(this.href, this.target, ' width=1000, height=600, menubar=no,directories=no,location=0,resizable=no');return false;' class='submenu'>Grado: ".$row2['SEM_GRADO_NUMERO']." ".$row2['SEM_GRADO_LETRA']."</a></center></td>";
