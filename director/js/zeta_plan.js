...
ajax.send( "matmateria="+materia+"&matmatricula="+matricula+"&matcalsificacion="+clacificacion+
...
if (numero==""){
	alert('Inserte un Grado en Numero al Nuevo Semestre');
	}else
if (letra==""){
	alert('Inserte un Grado en Letra al Nuevo Semestre');
	}else
if (materia==""){
	alert('Inserte el Numero de Materias para el Nuevo Semestre');
}else{
ajax.send("semestreplan="+plan+"&semestrenumero="+numero+"&semestreletra="+letra+"&semestremat="+materia  );
  alert('El Registro a sido Guardado');
