        ...
        <div id="my-tab-content" class="tab-content">
            ...
            <div class="col-xs-6 col-md-4"><!-- matricula -->
             ...
             <div class="col-xs-6 col-md-4"><!-- datos de la curp -->
               ...
               <div><input type="text" name="alumcurp" id="curp" class="cajita form-control" maxlength="18" style="text-transform:uppercase;" value="'.$alumcurp.'"></div>
             </div>           
              ...
              <div class="col-xs-6 col-md-4">
               ...
               <div><select name="alumturno" class="cajita form-control">
                    <option>Seleccione...</option>
                     <option value="1"';if($alumturno==1) print 'selected="true"';echo'>Mañana</option>
                     <option value="0"';if($alumturno==0) print 'selected="true"';echo'>Tarde</option>
                    </select></div>
              </div>               
      ...
      if(mysql_num_rows($res)==0){
		...
		<input type="hidden" name="doccurp2" id="doccurp2" class="cajita form-control" maxlength="18" value="'.$doccurp.'">
					...
					<div class="col-xs-6 col-md-4">
                     ...
                     <div class="col-xs-6 col-md-4">     
							 <div><label class="etiquetita">Fecha de Nacimiento</label></div>
							<div><input type="date" name="docnacimiento" id="name"  class="cajita form-control" placeholder="YYYY-MM-dd" value="'.$docnacimiento.'"></div><br>
                     </div>
