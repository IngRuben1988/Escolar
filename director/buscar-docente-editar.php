...
echo'
<center>
<table class="footable" width="80%" border="0">
	<thead>
 ...
 and doc_materno like ('%".$b4."%')order by  doc_paterno";
  ...
  if(mysql_num_rows($res)==0){
		  ...
		  while($row=mysql_fetch_array($res)){
			...
			echo "<td><center><a href='a-personas.php?MATRIX="; echo base64_encode($row["DOC_CURP"]);echo "&SKYNET=";echo base64_encode('Docente');echo "'><img src='../img/2000px-Blue_circle_for_diabetes.svg_.png' width='30%' height='30%'/></a></center></td>";
			echo "</tr>";
