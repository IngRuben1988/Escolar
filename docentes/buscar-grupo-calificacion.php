...
if(!empty($clave)){
	echo '
<select name="grupos" id="grupos" class="cajita form-control" onClick="return GruposListaCalificaciones(this);">
				<option>Seleccione...</option>';
		  Grupos($clave,$CURP);echo' </select>';
	  }  
  function Grupos($z,$c){
  $con=conexion();
	  ...
	  /*$sql=" select distinct cd.DATO_CLAVE  from conjunto_datos as cd,periodos as p
		...
		$sql="select*from consulta_docente_clases where per_id=".$z." and doc_curp='".$c."'";
