...
<table width="50%" border="0" class="footable">
	...
	<tr height="30px" id="fondo_tabla">
		...
		<td width="30%"><center><label id="titulo_tabla">Ciclo Escolar</label></center></td>
		<td width="20%"><center><label id="titulo_tabla">Calificacion Grupal</label></center></td>
	</tr>
	</thead>';	
$con=conexion();  
  $sql="
...
echo "<td><center><a href='boletas.php?salon=".$clave."&semestre=".$grado."' target='boletas' onclick=\"window.open(this.href, this.target, ' width=720, height=350, menubar=no,directories=no,location=0,resizable=no');return false;\"><img src='../img/impresora.png' width='30%' heigth='30%' ></a></center></td>";
...
///////////////////////////////////////////////////////////////////////////////////////////////////// 
function Salones($b){/////// Tabla de alumnos y salones
echo '<center>
<table width="100%" border="0" class="footable scrolling">
<thead>
	<tr height="50px" id="fondo_tabla">
    	<td width="10%"><center><label id="titulo_tabla">No.</label></center></td>
		...
		<td width="40%"><center><label id="titulo_tabla">Nombre Completo</label></center></td>
		<td width="15%"><center><label id="titulo_tabla">Calificar</label></center></td>
    </tr>
</thead>';	
$con=conexion();
  ...
  if(mysql_num_rows($res)==0){
	  echo'<center><b>No Hay Registros</b></center>';
		  ...
		  while($row=mysql_fetch_array($res)){ 
			...
			echo "<td><center><a href='calificacion-alumno.php?alumno=".$row['ALUM_CURP']."&salon=".$row['DATO_CLAVE']."&numero=".$row['DATO_CONSECUTIVO']."&paterno=".$row['ALUM_PATERNO']."&materno=".$row['ALUM_MATERNO']."&nombre=".$row['ALUM_NOMBRE']."&semestre=".$row['SEM_ID']."' target='calificacion-alumno' onclick=\"window.open(this.href, this.target, ' width=1000, height=820, menubar=no,directories=no,location=0,resizable=no');return false;\"><img src='../img/2000px-Blue_circle_for_diabetes.svg_.png' width='30%' heigth='30%' ></a></center></td>";
		  }
