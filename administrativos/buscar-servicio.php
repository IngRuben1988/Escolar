...
{
$con=conexion();
$sql='select p.ALUM_CURP,p.ALUM_MATRICULA,p.EST_ID,p.ALUM_PATERNO,p.ALUM_MATERNO,p.ALUM_NOMBRE,e.EST_ESTATUS
from alum_personas as p, estatus as e
where  e.EST_ID=p.EST_ID and alum_matricula='.$n;
...
<center><table width="80%" border="1">
  ...
  <tr height="30px">
    ...
    <td><label class="etiquetita">'.$n.'</label></td>
...
<center><table width="80%" border="1">
  <tr height="30px">
    ...
    <td><center><a href="zeta_x0002.php?curp='.$curp.'&servicio='.$s.'"><img src="../img/editar.png"></a></center></td>
  </tr>
</table></center>
